...
gender = st.sidebar.multiselect(
    "Select Gender",
    options=teachers["Gender"].unique(),
    default=teachers["Gender"].unique()
)

expertise = st.sidebar.multiselect(
    "Select Expertise",
    options=teachers["Expertise"].unique(),
...
category = st.sidebar.multiselect(
    ...
    options=courses["Course Category"].unique(),
    default=courses["Course Category"].unique()
)

level = st.sidebar.multiselect(
    "Select Course Level",
    options=courses["Course Level"].unique(),
...
expertise_rating = (
    filtered_teachers.groupby("Expertise")["Teacher Rating"]
    .mean()
    .reset_index()
)
...
gender_rating = (
    filtered_teachers.groupby("Gender")["Teacher Rating"]
    .mean()
    .reset_index()
)
...
category_rating = (
    filtered_courses.groupby("Course Category")["Course Rating"]
    .mean()
    .reset_index()
)
...
level_rating = (
    filtered_courses.groupby("Course Level")["Course Rating"]
    .mean()
    .reset_index()
)
